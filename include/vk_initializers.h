...
namespace vkinit
{
	...
	VkImageCreateInfo image_create_info(VkFormat format, VkImageUsageFlags usageFlags, VkExtent3D extent,VkSampleCountFlagBits msaaSamples = VK_SAMPLE_COUNT_1_BIT);
